...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/Attribute/Attic/GetValues.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:09:59 $ $Name:  $";
#endif /* DEBUG */
