...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/Attribute/Attic/PCreateFromArray.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:10:45 $ $Name:  $";
#endif /* DEBUG */
