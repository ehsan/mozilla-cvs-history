...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/Attribute/Attic/PAddValue.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:10:30 $ $Name:  $";
#endif /* DEBUG */
