...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/RelativeDistinguishedName/Attic/MVCreate.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:14:23 $ $Name:  $";
#endif /* DEBUG */
