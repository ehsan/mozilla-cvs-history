...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/Name/Attic/PCreateFromRDNSequence.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:13:56 $ $Name:  $";
#endif /* DEBUG */
