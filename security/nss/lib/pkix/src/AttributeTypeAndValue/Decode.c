...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/AttributeTypeAndValue/Attic/Decode.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:13:08 $ $Name:  $";
#endif /* DEBUG */
