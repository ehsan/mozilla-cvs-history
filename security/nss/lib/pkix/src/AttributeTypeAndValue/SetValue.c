...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/AttributeTypeAndValue/Attic/SetValue.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:13:35 $ $Name:  $";
#endif /* DEBUG */
