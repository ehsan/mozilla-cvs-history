...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvs/cvsroot/mozilla/security/nss/lib/pkix/src/AlgorithmIdentifier/Attic/SetAlgorithm.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:08:53 $ $Name:  $";
#endif /* DEBUG */
