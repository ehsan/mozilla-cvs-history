...
class TTest(object):
    ...
    def initializeProfile(self, profile_dir, browser_config):
        ...
        if self._ffprocess.checkAllProcesses(browser_config['process']):
    ...
    def runTest(self, browser_config, test_config):
        ...
        try:
            ...
            for i in range(test_config['cycles']):
                ...
                if (i > 0) and self._ffprocess.checkAllProcesses(browser_config['process']):
            ...
            self._ffprocess.cleanupProcesses(browser_config['process'], browser_config['browser_wait']) 
