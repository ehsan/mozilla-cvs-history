...
function toggleVettingStatus() {
  if (! isWhitespace(document.getElementById("vetted_start_date").value) ||
      ! isWhitespace(document.getElementById("vetted_end_date").value)) {
    document.getElementById("vetted_only_vetted").checked = true;
  }  else {
    document.getElementById("vetted_only_all").checked = true;
  }
}
